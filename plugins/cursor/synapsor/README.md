...
```bash
npx -y -p @synapsor/runner@1.6.3 synapsor-runner mcp status cursor --project --check-launch
```
...
This 1.6.3 plugin is prepared for local validation and Cursor Marketplace
