...
4. Run the pinned Runner scaffold with a shell-safe action identifier and the
   ...
   `npx -y -p @synapsor/runner@1.5.3 synapsor-runner start --action <action_name> --description "<reviewed intent>"`
...
6. Run the project formatter for the action file, then run:
   ...
   `npx -y -p @synapsor/runner@1.5.3 synapsor-runner action validate <generated-action.ts> --json`
