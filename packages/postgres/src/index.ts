...
function wireResult(result: Record<string, unknown>): WritebackResult {
  return Object.fromEntries(Object.entries(result).filter(([, value]) => value !== undefined)) as WritebackResult;
}
