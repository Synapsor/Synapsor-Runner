...
npx -y -p @synapsor/runner@alpha synapsor-runner demo --quick --no-interactive > quick.txt
...
npx -y -p @synapsor/runner@alpha synapsor-runner activity search --object invoice:INV-3001 --store ./.synapsor/quick-demo.db >/dev/null
...
npx -y -p @synapsor/runner@alpha synapsor-runner replay show latest --store ./.synapsor/quick-demo.db >/dev/null
npx -y -p @synapsor/runner@alpha synapsor-runner store stats --store ./.synapsor/quick-demo.db >/dev/null
