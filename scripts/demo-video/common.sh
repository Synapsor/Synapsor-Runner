...
DEMO_VIDEO_SHORT_RENDER_DIR="$DEMO_VIDEO_RENDER_DIR/short"
DEMO_VIDEO_SHORT_FRAMES_DIR="$DEMO_VIDEO_SHORT_RENDER_DIR/frames"
DEMO_VIDEO_SHORT_DECK="$DEMO_VIDEO_SHORT_RENDER_DIR/safe-action-deck.html"
...
DEMO_VIDEO_SHORT_MP4="$DEMO_VIDEO_OUTPUT_DIR/synapsor-safe-action-demo.mp4"
DEMO_VIDEO_SHORT_GIF="$DEMO_VIDEO_OUTPUT_DIR/synapsor-safe-action-demo.gif"
DEMO_VIDEO_SHORT_POSTER="$DEMO_VIDEO_OUTPUT_DIR/synapsor-safe-action-poster.jpg"
DEMO_VIDEO_RUNNER_VERSION="${SYNAPSOR_DEMO_RUNNER_VERSION:-1.5.3}"
...
DEMO_VIDEO_SHORT_DURATION_SECONDS=36
